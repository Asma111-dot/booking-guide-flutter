...
class CustomTheme {
 ...
 // String getFont() => 'Baloo_Bhaijaan_2';
  ...
  static const primaryColor = Color(0xff4A90E2); // Light blue
  static const secondaryColor = Color(0xFF2C3E50); // Dark blue
  static const tertiaryColor = Color(0xffF0F0F0); // Light gray

  static const Color placeholderColor = Color(0xffe0e0e0); // Light gray color
  static const Color shimmerBaseColor = Color(0xffdcdcdc); // Slightly darker gray color
  static const Color shimmerHighlightColor = Color(0xffe6e6e6); // Light gray color for shimmer highlights
