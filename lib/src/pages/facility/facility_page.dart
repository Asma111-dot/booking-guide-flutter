// // appBar: AppBar(
// //   title: Text('الشاليهات'),
// //   actions: [
// //     IconButton(
// //       icon: Icon(Icons.favorite),
// //       onPressed: () {
// //         final savedItems = ref.read(savedItemsProvider);
// //         Navigator.push(
// //           context,
// //           MaterialPageRoute(
// //             builder: (context) => FavoritesPage(savedItems: savedItems),
// //           ),
// //         );
// //       },
// //     ),
...
//     final firstPrice = firstRoom?.roomPrices.first.amount ?? 0.0;
//
//     // اختيار الصورة الافتراضية بناءً على نوع المرفق
...
//             ),
//             child: facility.logo != null && facility.logo!.isNotEmpty
//                 ? CachedNetworkImage(
