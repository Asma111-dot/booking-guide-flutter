...
//   @override
//   String toString() {
//     return 'Reservation(id: $id, userId: $userId, roomPriceId: $roomPriceId, checkInDate: "$checkInDate", checkOutDate: "$checkOutDate", status: "$status", bookingType: "$bookingType", adultsCount: $adultsCount, childrenCount: $childrenCount)';
//   }
//
//   @override
